...
CREATE TABLE IF NOT EXISTS brands (
  id INT PRIMARY KEY AUTO_INCREMENT,
  name VARCHAR(100) NOT NULL UNIQUE COMMENT '品牌名',
...
-- 给 products 表增加 brand_id 字段
ALTER TABLE products ADD COLUMN brand_id INT AFTER category;
